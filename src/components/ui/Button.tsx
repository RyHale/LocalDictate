...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    "font-medium rounded-lg border focus:outline-none transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer";

  const variantClasses = {
    primary:
      "text-on-accent bg-background-ui border-background-ui hover:bg-background-ui/88 hover:border-background-ui/88 focus:ring-1 focus:ring-background-ui",
    "primary-soft":
      "text-text bg-logo-primary/20 border-transparent hover:bg-logo-primary/30 focus:ring-1 focus:ring-logo-primary",
    secondary:
      "bg-control border-transparent hover:bg-logo-primary/10 hover:border-logo-primary/30 focus:outline-none",
    ...
    ghost:
      "text-current border-transparent hover:bg-logo-primary/10 focus:bg-logo-primary/15",
  };
