...
const ModelDropdown: React.FC<ModelDropdownProps> = ({
  ...
  return (
    <div className="absolute bottom-full start-0 z-50 mb-2 max-h-[60vh] w-80 overflow-y-auto rounded-xl border border-mid-gray/20 bg-background-raised py-2 shadow-xl">
